...
<html>
	<head>
		<title>威富通微信WAP支付退款查询测试页面</title>
		...
		<script type="text/javascript">
			...
			function doSubmit(){
				...
				if(out_trade_no == '' && transaction_id == '' && out_refund_no == '' && refund_id == ''){
					alert('商户订单号、威富通订单号、商户退款单号、威富通退款单号至少填一个');
					return false;
				}
				$("form").submit();
			}
...
<body text=#000000 bgColor="#ffffff" leftMargin=0  topMargin=4>
	<div id="main">
        <div class="cashier-nav">
            <ol>
				<li class="current">4、提交信息（威富通微信WAP支付退款查询） </li> 
            </ol>
        </div>
        <form action="testRefundQuery" method="post"  target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd class="hideClass">
						<input name="service" value="trade.refund.query" readonly="readonly" maxlength="32"  placeholder="长度32"/>
